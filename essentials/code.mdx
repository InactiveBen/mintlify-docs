...
██║     ███████╗╚██████╔╝███████╗██║ ╚████║   ██║   
╚═╝     ╚══════╝ ╚═════╝ ╚══════╝╚═╝  ╚═══╝   ╚═╝
Note: It is not mandatory, but strongly recommended to include task.wait(3) at the beginning of your code. If you prefer not to use the wait, you can utilize the Fluent.lua version instead.

--]]
task.wait(3) -- Waits for 3 seconds to ensure assets are ready.
local Main = require(93780747008999) -- ITS OPEN SOURCE. :)
print("Currently running Fluent Version: " .. Main.Version) -- This will print the current version of Fluent.
```
